    ...
    .run([
      ...
      function ($templateCache) {
        $templateCache.put('template/treeGrid/treeGrid.html',
          ...
          " <table  class=\"tree-grid table table-bordered table-striped\">\n" +
          "   <thead>\n" +
          "     <tr>\n" +
		  ...
		  "             <a ng-href=\"{{row.branch.Url}}\" ng-class=\"row.branch.IsProject==false ? 'tree-label-bold' : 'tree-label-normal'\" target=\"_blank\">{{row.branch[expandingProperty.field] || row.branch[expandingProperty]}}</a></span>\n" +
          "       </td>\n" +
          "       <td ng-repeat=\"col in colDefinitions\">\n" +
		  "			<div ng-show=\"row.branch['IsProject']===true\">\n" +
      ...
      function ($timeout,
        ...
        return {
          ...
          link       : function (scope, element, attrs) {
            ...
            attrs.iconExpand = attrs.iconExpand ? attrs.iconExpand : 'fa fa-plus-circle';
            attrs.iconCollapse = attrs.iconCollapse ? attrs.iconCollapse : 'fa fa-minus-circle';           
  ...
  .filter('searchFor', function() {
		...
		function checkItem(item, filterString, col) {
			if (col.sortingType === "number") {
				if (item.branch["ExcludeFromProjectSummary"]==="No" && item.branch[col.field] != null
