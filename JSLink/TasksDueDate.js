...
PMO.ProjectTask.CustomizeFieldRendering = function () {
	//SP.SOD.registerSod
	RegisterSod('TasksDueDate.js', '/Style%20Library/PMOCustom/js/TasksDueDate.js');
    LoadSodByKey('TasksDueDate.js', null);
...
PMO.ProjectTask.CustomizeFieldRendering();

if (typeof _spPageContextInfo != "undefined" && _spPageContextInfo != null) {    		
	// CSR-override for MDS enabled site
	RegisterModuleInit(_spPageContextInfo.siteServerRelativeUrl + "/Style%20Library/PMOCustom/js/TasksDueDate.js", PMO.ProjectTask.CustomizeFieldRendering); 
}